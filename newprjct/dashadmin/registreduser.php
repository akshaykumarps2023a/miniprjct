...
<body>
    <div>
        ...
        <div class="content">
            ...
            <!-- Table Start -->
            <div class="container-fluid pt-4 px-100" style="width: 100%;">
                <div class="row g-100" style="width: 100%;" >
                            ...
                            <table class="table table-hover">
                                ...
                                <?php
                                    ...
                                    ?>
                                        ...
                                        <!-- <form action="delete_reguser_submit.php" method="post">
                                        <td><input type="hidden" name="id" value="<?php echo $row['login_id'];?>">
                                        <input type="submit" value="delete"name="delete"></td>
                                        </form> -->
                                        <form action="approvestatus.php" method="post">
                                        <td><input type="hidden" name="id" value="<?php echo $row['login_id'];?>">
                                        <!-- <input type="submit" value="approve"name="approve"> -->
                                        <button type="submit" class="btn btn-outline-success m-20" name="approve">Activate</button></td>
                                        </form>
                                        <form action="reject.php" method="post">
                                        <td><input type="hidden" name="id" value="<?php echo $row['login_id'];?>">
                                        <!-- <input type="submit" value="reject"name="reject"> -->
                                        <button type="sumit" class="btn btn-outline-danger m-2" name="reject">Deactivate</button></td>
                                        </form>
                                    </tr>
                                    <?php
                                    }
