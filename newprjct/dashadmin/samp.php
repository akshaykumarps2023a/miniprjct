...
15 of 1,424
Fwd: login reistartion code

AKHILA VARGHESE
Tue, Sep 20, 9:27 AM (1 day ago)
to me



---------- Forwarded message ---------
From: VISHNU MOHAN RMCA 2021-2023 B <vishnumohan2023b@mca.ajce.in>
Date: Mon, Sep 19, 2022 at 8:30 PM
Subject: Fwd: login reistartion code
To: <akhilavarghese2023a@mca.ajce.in>



---------- Forwarded message ---------
From: VISHNU MOHAN RMCA 2021-2023 B <vishnumohan2023b@mca.ajce.in>
Date: Mon, Sep 19, 2022, 7:25 PM
Subject: login reistartion code
To: <vismayamohan2023b@mca.ajce.in>
...
<?php
    ...
    if(isset($_POST['signup-submit']))
    {
        ...
        $role=$_POST['role'];
        $status=1;
        $sql1 = "INSERT INTO `tbl_registration`(`u_Id`, `name`, `phoneNumber`, `gender`, `user_passwrd`, `user_role`, `status`) VALUES ('$uid', '$name', '$phone', '$gender', '$pass', '$role', '$status')";
                    ...
                    <div class="signup-input-div">
                        ...
                        <i class="fa fa-tasks icon"></i>
                            <select name="role" id="reg_role" required>
                                ...
                                <option value="delivary_agent">Seller</option>
                                <option value="delivary_agent">Delivary Agent</option>
                            </select>
                        </div>
                    </div>
